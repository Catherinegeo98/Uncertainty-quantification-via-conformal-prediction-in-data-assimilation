...
- mainDA_NN.py: Peforms twin experiments and generated training data for the CNN with perturbations to CNN (configuration 1)
- mainDA_EnKF.py: Peforms twin experiments and generated training data for the CNN with perturbations to CNN (configuration 1)
